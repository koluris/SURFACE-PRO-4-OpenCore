 ...
 *
 * Disassembly of iASLRUyaG0.aml, Sun Jul 31 10:05:46 2022
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000180FB (98555)
 *     Revision         0x02
 *     Checksum         0xDC
 *     OEM ID           "MSFT  "
 *     OEM Table ID     "MSFT    "
...
DefinitionBlock ("", "DSDT", 2, "MSFT  ", "MSFT    ", 0x00000000)
{
    ...
    Name (SS3, Zero)
    Name (SS4, One)
    OperationRegion (GNVS, SystemMemory, 0x8BEBB000, 0x082C)
    ...
    Scope (_SB)
    {
        ...
        Device (WSID)
        {
            ...
            {
                ADBG ("_SB.WSID._DSM")
                If ((Arg0 == ToUUID ("fa62fafd-c5d4-48ac-b31e-896aa4f68438") /* Unknown UUID */))
                {
                    If ((Zero == ToInteger (Arg1)))
                    {
                        Switch (ToInteger (Arg2))
        ...
        Device (SARB)
        {
            ...
            Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
            {
                If ((Arg0 == ToUUID ("cf25be87-4621-40ce-bf12-2ff9ff5d38c4") /* Unknown UUID */))
                {
                    If ((Zero == ToInteger (Arg1)))
                    {
                        Switch (ToInteger (Arg2))
